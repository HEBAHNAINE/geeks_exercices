...
// crée un nouveau tableau avec l'opérateur spread
...
// Une string est itérable caractère par caractère
console.log([...country]);  
// ["U", "S", "A"]
////////////////////
let newArray = [...[,,]];
...
const users = [
  ...
  console.log("Welcome Students:", welcomeStudents);
  // 
  const fullStackResidents = users.filter(user => user.role === "Full Stack Resident");
  console.log("Full Stack Residents:", fullStackResidents);
  //
  const lastNamesResidents = users
    .filter(user => user.role === "Full Stack Resident")
    .map(user => user.lastName);
  console.log("Last Names Residents:", lastNamesResidents);
